...
import 'package:flutter_operations_p/ui/pages/screen/wallet/calculation_wallet.dart';
...
class AppRoutes {
  ...
  // MenuOption(route: 'home', icon: Icons.home, name: 'Home', screen: HomeScreen()),
   // MenuOption(route: 'alert', icon: Icons.alternate_email_sharp, name: 'Alert', screen: const AlertScreen()),
    MenuOption(route: 'cartera', icon: Icons.wallet, name: 'Analisis de produccion anual por sucursal', screen: const CalculationWallet()),
